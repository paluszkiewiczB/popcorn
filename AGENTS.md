...
This project is indexed by GitNexus as **popcorn** (412 symbols, 1104 relationships, 16 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
